...
class JobKeywords:
    ...
    def calculate_tfidf(self):
        ...
        for idx, row in self.grouped_df.iterrows():
            ...
            self.keywords_df = self.keywords_df.append({'job': job, 'keywords': top_20_keywords, '자소서갯수': content_count}, ignore_index=True)
...
if __name__ == "__main__":
    extractor = JobKeywords('/home/ubuntu/workspace/SemiPJT_team2/jobkorea_all_cleansing_done.csv')
    extractor.run('/home/ubuntu/workspace/SemiPJT_team2/job_keywords_top20.csv')
