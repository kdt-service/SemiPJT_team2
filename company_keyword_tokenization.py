...
if __name__ == "__main__":
    extractor = CompanyKeywords('/home/ubuntu/workspace/SemiPJT_team2/jobkorea_all_cleansing_done.csv')
    extractor.run('/home/ubuntu/workspace/SemiPJT_team2/company_keywords_top20.csv')
